...
class AppNotificationsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Items', 'AppWishLists', 'StockGroups']
        ];
    ...
    public function view($id = null)
    {
        $appNotification = $this->AppNotifications->get($id, [
            'contain' => ['Items', 'AppWishLists', 'StockGroups', 'AppNotificationCustomers']
        ]);
    ...
    public function add()
    {
        ...
        $appWishLists = $this->AppNotifications->AppWishLists->find('list', ['limit' => 200]);
        $stockGroups = $this->AppNotifications->StockGroups->find('list', ['limit' => 200]);
        $this->set(compact('appNotification', 'items', 'appWishLists', 'stockGroups'));
        $this->set('_serialize', ['appNotification']);
    }
