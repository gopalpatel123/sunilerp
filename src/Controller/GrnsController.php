...
class GrnsController extends AppController
{
    ...
    public function index()
    {
        ...
        $grns = $this->paginate($this->Grns->find()->where(['Grns.company_id'=>$company_id,'Grns.financial_year_id'=>$financialYear_id])->where([
		'OR' => [
		...
		$grnsDatas=$this->Grns->find()->contain(['GrnRows'])->where(['Grns.company_id'=>$company_id,'Grns.financial_year_id'=>$financialYear_id,'Grns.status'=>'Pending','Grns.location_id'=>$location_id])->toArray();
