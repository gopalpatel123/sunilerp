...
public function excelExport(){
		...
		if($first_time=="No"){ 
			 ...
			 $ItemsDatas=$this->ItemLedgers->Items->find()->contain(['Shades','Sizes','StockGroups'=>['ParentStockGroups']])->where($where)->where(['Items.company_id'=>$company_id ,'Items.created_on <='=>$to_date]); 
		    $remaining=[];$unit_rate=[];
