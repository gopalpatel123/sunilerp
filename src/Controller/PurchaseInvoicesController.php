...
class PurchaseInvoicesController extends AppController
{
    ...
    public function index()
    {
        ...
        $purchaseInvoices = $this->paginate($this->PurchaseInvoices->find()->where(['PurchaseInvoices.company_id'=>$company_id,'PurchaseInvoices.financial_year_id'=>$financialYear_id])->where([
		'OR' => [
