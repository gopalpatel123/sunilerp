...
class PurchaseReturnsController extends AppController
{
    ...
    public function index()
    {
		...
		if($search){
        $purchaseReturns = $this->paginate($this->PurchaseReturns->find()->where(['PurchaseReturns.company_id'=>$company_id,'PurchaseReturns.financial_year_id'=>$financialYear_id])->where([
		'OR' => [
