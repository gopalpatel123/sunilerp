...
class SalesInvoicesController extends AppController
{
    ...
    public function index($status = Null)
    {
		...
		$salesInvoices = $this->paginate($this->SalesInvoices->find()->where(['SalesInvoices.company_id'=>$company_id,'SalesInvoices.financial_year_id'=>$financialYear_id])->where([
		'OR' => [
        ...
        $this->set(compact('salesInvoices','search','status','location_id'));
