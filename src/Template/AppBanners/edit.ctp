 ...
 */
$this->set('title', 'Update App Banners');
?>
<div class="row">
	<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-green-sharp bold ">Update App Banners</span>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php echo $this->requestAction('/Items/getEditItems?item_id='.$appBanner->item_id); ?>
							...
							<div class="col-md-12">
								...
								if(!empty($appBanner->banner_image)){
									$result=$awsFileLoad->cdnpath();
									echo $this->Html->image($result.'/'.$appBanner->banner_image,['class'=>'img-responsive thumbnail','style'=>'height: 160px;','id'=>'imgshw1']);
									
									echo $this->Form->control('banner_image_exist',['class'=>'form-control input-sm','label'=>false, 'type' =>'hidden','value'=>$appBanner->banner_image]);
								}else{  ?>
