						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								if(!empty($item->image_url)){
									...
									echo $this->Html->image($result.'/'.$item->image_url,['class'=>'img-responsive thumbnail','style'=>'height: 98px;','id'=>'imgshw1']);
									
									echo $this->Form->control('image_url_exist',['class'=>'form-control input-sm','label'=>false, 'type' =>'hidden','value'=>$item->image_url]);
								}else{  ?>
                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<?php echo $this->Form->control('discount',['class'=>'rightAligntextClass form-control input-sm discount','label'=>false,'placeholder'=>'Sales Rate','required'=>'required']); ?>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
