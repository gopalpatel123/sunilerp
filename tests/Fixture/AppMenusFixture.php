...
class AppMenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title_content' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'lft' => 1,
            'rght' => 1,
            'title_content' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
