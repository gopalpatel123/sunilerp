...
use App\Model\Table\AppBannersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppBannersTable Test Case
 */
class AppBannersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppBannersTable
     */
    public $AppBanners;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppBanners') ? [] : ['className' => AppBannersTable::class];
        $this->AppBanners = TableRegistry::get('AppBanners', $config);
    }
