...
use App\Model\Table\AppBrandsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppBrandsTable Test Case
 */
class AppBrandsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppBrandsTable
     */
    public $AppBrands;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppBrands') ? [] : ['className' => AppBrandsTable::class];
        $this->AppBrands = TableRegistry::get('AppBrands', $config);
    }
