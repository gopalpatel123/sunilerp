...
use App\Model\Table\AppCustomerAddressesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppCustomerAddressesTable Test Case
 */
class AppCustomerAddressesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppCustomerAddressesTable
     */
    public $AppCustomerAddresses;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppCustomerAddresses') ? [] : ['className' => AppCustomerAddressesTable::class];
        $this->AppCustomerAddresses = TableRegistry::get('AppCustomerAddresses', $config);
    }
    ...
    {
        unset($this->AppCustomerAddresses);
