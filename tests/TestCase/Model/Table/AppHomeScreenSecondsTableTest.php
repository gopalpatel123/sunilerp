...
use App\Model\Table\AppHomeScreenSecondsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppHomeScreenSecondsTable Test Case
 */
class AppHomeScreenSecondsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppHomeScreenSecondsTable
     */
    public $AppHomeScreenSeconds;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppHomeScreenSeconds') ? [] : ['className' => AppHomeScreenSecondsTable::class];
        $this->AppHomeScreenSeconds = TableRegistry::get('AppHomeScreenSeconds', $config);
    }
    ...
    {
        unset($this->AppHomeScreenSeconds);
