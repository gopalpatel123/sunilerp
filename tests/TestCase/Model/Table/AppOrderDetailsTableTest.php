...
use App\Model\Table\AppOrderDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppOrderDetailsTable Test Case
 */
class AppOrderDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppOrderDetailsTable
     */
    public $AppOrderDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppOrderDetails') ? [] : ['className' => AppOrderDetailsTable::class];
        $this->AppOrderDetails = TableRegistry::get('AppOrderDetails', $config);
    }
