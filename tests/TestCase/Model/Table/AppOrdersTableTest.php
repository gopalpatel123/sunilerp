...
use App\Model\Table\AppOrdersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppOrdersTable Test Case
 */
class AppOrdersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppOrdersTable
     */
    public $AppOrders;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppOrders') ? [] : ['className' => AppOrdersTable::class];
        $this->AppOrders = TableRegistry::get('AppOrders', $config);
    }
