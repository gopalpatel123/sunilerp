...
use App\Model\Table\AppWishListItemsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppWishListItemsTable Test Case
 */
class AppWishListItemsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppWishListItemsTable
     */
    public $AppWishListItems;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppWishListItems') ? [] : ['className' => AppWishListItemsTable::class];
        $this->AppWishListItems = TableRegistry::get('AppWishListItems', $config);
    }
