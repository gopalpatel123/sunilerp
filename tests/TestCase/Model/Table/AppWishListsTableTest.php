...
use App\Model\Table\AppWishListsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AppWishListsTable Test Case
 */
class AppWishListsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AppWishListsTable
     */
    public $AppWishLists;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AppWishLists') ? [] : ['className' => AppWishListsTable::class];
        $this->AppWishLists = TableRegistry::get('AppWishLists', $config);
    }
