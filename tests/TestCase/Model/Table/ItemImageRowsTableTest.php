...
use App\Model\Table\ItemImageRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ItemImageRowsTable Test Case
 */
class ItemImageRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ItemImageRowsTable
     */
    public $ItemImageRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ItemImageRows') ? [] : ['className' => ItemImageRowsTable::class];
        $this->ItemImageRows = TableRegistry::get('ItemImageRows', $config);
    }
